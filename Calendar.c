//*******************************************************************************************************************
                               //SIMPLE_CALENDER_USING_C_PROGRAMMING

                                        // CODED-BY: THANUJA D

 //******************************************************************************************************************

#include <stdio.h>                 // Heared files included
...
int main(int argc, char* argv[]){
    ...
    fp = fopen("note.bin", "r");            // Opens file in bin mode
...

    {
      ...
      switch(choice) {
        ...
        case '3':
          ...
          fp = fopen("note.bin", "a+");           //opens a file write at EOF
